...
import com.example.njhcode.colortabdemo.R;
...
public class ColorClipTabLayout extends CTabLayout {
...
//            }
    ...
    public static class ColorClipTabLayoutOnPageChangeListener extends TabLayoutOnPageChangeListener {
        ...
        public ColorClipTabLayoutOnPageChangeListener(CTabLayout tabLayout) {
            super(tabLayout);
