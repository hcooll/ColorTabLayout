...
public class CTabLayout extends FrameLayout {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        System.out.println("===>>> onScrollChanged l:" + l);
    }
    ...
    /**
     * Add a {@link CTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
    ...
    /**
     * Remove the given {@link CTabLayout.OnTabSelectedListener} that was previously added via
...
/*            if ((mOvalHeight == -1) || (mOvalWidth == -1)) {
     ...
     * necessary calls back to the provided {@link CTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CTabLayout> mTabLayoutRef;
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final CTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link CTabLayout.OnTabSelectedListener} class which contains the necessary calls back
    ...
    public static class ViewPagerOnTabSelectedListener implements CTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(CTabLayout.Tab tab) {
